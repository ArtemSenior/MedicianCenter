    ...
    public partial class AuthForm : Form
    {
        ...
        private void AuthButton_Click(object sender, EventArgs e)
        {
            ...
            StateSingleton.getInstance().connectionString =
                $"Data Source=LAPTOP-CLVPR4Q1;Initial Catalog=Poliklinika;Persist Security Info=True;User ID={UsernameTextBox.Text};Password={PasswordTextBox.Text};Encrypt=False";
